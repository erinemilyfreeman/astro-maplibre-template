...
import Assignment01Map06 from "../assets/img/WI_Assembly_Districts_2002_2024.png"
import Assignment02 from "../assets/img/city-of-madison-absentee-voting.png"
import AssemblyDistricts543LandUse from "../assets/img/dane-county-land-use.png"
...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    2002, 2012, 2022, and 2024 Wisconsin Assembly Districts and 2020 Presidential Election Results with Wards 

    <img src={Assignment01Map06.src} alt="image description" />


    2024 absentee voting locations in the City of Madison   

    <img src={Assignment02.src} alt="image description" />


    2024 Dane County Land Use, 2024 Assembly Districts, and 2024 Wards

    <img src={AssemblyDistricts543LandUse.src} alt="image description" />

    ## Dane County 

    In the 2024 Presidential Election, Kamala Harris won Dane County with 75.1%.

    ### Sauk County
    
    In the 2024 Presidential Election, Donald Trump won Sauk County with 50%.
